...
public class PolymorphismTests
{
    ...
    public async Task Query_BaseClass_ReturnsAllDerivedTypes()
    {
        ...
        var all = await db.GetManyAsync<BaseEntity>(cancellationToken: TestContext.Current.CancellationToken).ToListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Query_MiddleClass_ReturnsMiddleAndDerived()
    {
        ...
        var people = await db.GetManyAsync<Person>(cancellationToken: TestContext.Current.CancellationToken).ToListAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Query_LeafClass_ReturnsOnlyExactType()
    {
        ...
        var employees = await db.GetManyAsync<Employee>(cancellationToken: TestContext.Current.CancellationToken).ToListAsync(TestContext.Current.CancellationToken);
